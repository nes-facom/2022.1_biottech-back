...
class PedidosGetRequestBody {
    ...
    private $id;
    private $num_previsao;
    private $processo_sei;
    private $equipe_executora;
    private $data_solicitacao;
    private $titulo;
    private $especificar;
    private $exper;
    private $num_ceua;
    private $vigencia_ceua;
    private $num_aprovado;
    private $num_solicitado;
    private $adendo_1;
    private $adendo_2;
    private $sexo;
    private $idade;
    private $peso;
    private $observacoes;
    private $vinculo_institucional;
    private $projeto;
    private $especie;
    private $linha_pesquisa;
    private $nivel_projeto;
    private $laboratorio;
    private $finalidade;
    private $pesquisador;
    private $linhagem;
    private $previsao;
    private $saldoCEUA;
    private $saldoPrevisao;
    private $totalRetirado;
